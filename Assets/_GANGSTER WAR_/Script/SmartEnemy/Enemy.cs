...
public class Enemy : MonoBehaviour,ICanTakeDamage, IListener {
    ...
    [HideInInspector] public STARTBEHAVIOR startBehavior = STARTBEHAVIOR.WALK_LEFT;
    ...
    [HideInInspector] public float spawnDelay = 1;
    ...
    [HideInInspector] public float damagePoisonPerSecond;
...
//	_2dxFX_Frozen[] iceFX;
    ...
    public void TakeDamage(float damage, Vector2 force, Vector2 hitPoint, GameObject instigator, BODYPART bodyPart = BODYPART.NONE, WeaponEffect weaponEffect = null, WEAPON_EFFECT forceEffect = WEAPON_EFFECT.NONE)
    {
        ...
        FloatingTextManager.Instance.ShowText("" + (int) damage, transform.position, healthBarOffset, Color.red);
