...
public class GameMode : MonoBehaviour
{
    ...
    public int upgradeDoublePistolPrice = 250;
    public int upgradeSubmachineGunPrice = 300;
    public int upgradeShotgunPrice = 400;
    public int upgradeMachineGunPrice = 500;

    [Header("PLAYER & ITEM PRICE")]
    public int grenadePrice = 50;
    public int rocketPrice = 100;

    public int dualPistolPrice = 50;
    public int submachineGunPrice = 200;
    public int shotgunPrice = 300;
    public int machinegunPrice = 400;
